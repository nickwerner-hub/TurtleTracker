...
#
# Created by: Nicholas Werner (nicholas.werner@duke.edu)
...
# Use the split command to parse the items in lineString into a list object - \t signals that the variables are spearated by a tab
